...
Available_Domain='kNwD:AP-SINGAPORE-1-AD-1'
# 镜像                   [source_id]
Image_ID='ocid1.image.oc1.ap-singapore-1.aaaaaaaa3vsfhyvqje5yyn2vrr52tfnm5j2xovxyl2uojexvead5mesrh7ba'
# 子网ID                 [subnet_id]
Subnet_ID='ocid1.subnet.oc1.ap-singapore-1.aaaaaaaarrfprv6ja4njk5eeff35ilvnzwbyvabwznafrgqsggeli5k6drqa'
# 公钥                   [ssh_authorized_keys]
SSH_Key_PUB="ssh-rsa  ssh-key-2021-11-04"
# 租户ID                 [compartment_id]
Compartment_ID='ocid1.tenancy.oc1..aaaaaaaawhrm7ijnp63pqcel6hz35hjub47ljmd6j3hu3ja32lvh7gbn2guq'
# 配置                   [shape]
...
HD=200
# 实例名称
Instance_Name="instance-20211105-0023"
# 哪个区的
TTNAME="新加坡arm"
...
TOKEN=1065058990:AAFUBWSqcH_jE3AQTIig1r_zKUSUe0EqmDg
